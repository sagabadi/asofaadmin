                    ...
                    <form id="form" data-parsley-validate="" method="post" action="<?= base_url('/store_hadiah')?>">
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-lg-9">
                                <input id="inputEmail2" type="text" required="" name="nama_hadiah"  placeholder="Nama Hadiah" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card-body">
                    <form id="form" data-parsley-validate="" method="post" action="<?= base_url('/update_hadiah')?>">
                        <div class="form-group row">
                            <label for="inputEmail2" class="col-3 col-lg-3 col-form-label text-left">Nama Hadiah</label>
                            <div class="col-9 col-lg-9">
                                <input id="inputEmail2" type="text" required="" name="nama_hadiah" placeholder="Nama Hadiah" class="form-control nama_hadiah">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail2" class="col-3 col-lg-3 col-form-label text-left">Valuable Price</label>
